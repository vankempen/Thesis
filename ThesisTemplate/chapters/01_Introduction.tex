...
As will be shown in \todo{ref} does the buying of an option on a flight ticket in certain situations be beneficial for the passenger compared to buying the underlying ticket immediately or waiting a few days before making the purchasing decision. \todo[When the customer makes more inaccurate price movement predictions relative to the seller, he will more likely make the wrong initial decision, and is thus better off buying the lock-in product.]{is this so?}
