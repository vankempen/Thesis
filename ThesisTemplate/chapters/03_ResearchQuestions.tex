...
\item[Forecasting technique] This variable represents the techniques a customer applies to make its own forecast. In my models I will consider three types of techniques, namely predictions based upon: \begin{inparaenum}[\itshape (i)\upshape]
