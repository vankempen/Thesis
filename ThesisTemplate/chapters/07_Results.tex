...
While running the simulation for all the different routes, some flight's total profits were influenced more by the decline in accuracy for the seller than others. \todo{ref to Appendix with results per route} shows the detailed results of the realized profits for each individual routes.
