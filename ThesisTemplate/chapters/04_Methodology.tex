...
For illustration, an example extract from the HDF5-data matrix containing the first few flights of the route AMS-JFK can be seen in \todo{ref img}

\todo[Illustration]{illustration of data matrix}
...
\todo[somewhere]{four times per day -> intention?}
