...
\todo[number of outliers expected in dataset vs actual?]{here}
...
The last visual confirmation that the data containing airfare fluctuations in not normally distributed can be found in the normal probability plot. This figure evidently shows that the data does not follow a straight line as a normal dataset would. 

\todo[test of normality]{here}
